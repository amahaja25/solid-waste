...
categories_description = {
    'balloon': 'According to a <a class="info-link" href="https://mde.maryland.gov/programs/land/SolidWaste/Pages/balloons.aspx" target="_blank"> Maryland law</a> passed in the 2021 legislative session, people may not intentionally release a balloon into the atmosphere or participate in mass balloon releases, which consist of 10 or more balloons being released into the atmosphere. <br><br> Exceptions include unintentionally released balloons and balloons released for meteorological or official scientific research purposes.',
    'wood-waste': 'According to the MDE, <a class="info-link" href="https://mde.maryland.gov/programs/Land/SolidWaste/Documents/NWWRF_Factsheet.pdf" target="_blank">natural wood waste</a> generally occurs when land is cleared for construction. This type of waste consists of discarded vegetation “in its natural state.” <br><br> Natural wood waste has to be disposed of in specific Natural Wood Waste Recycling Facilities, which process tree stumps, logs and limbs. The facilities make mulch and compost out of the wood waste and distribute or sell it afterwards, according to the MDE.',
    'hazardous-waste': 'Hazardous waste is any substance that threatens to harm human health or the environment or has the potential to “cause or contribute to an increase in mortality or serious illness,” <a class="info-link" href="https://mde.maryland.gov/programs/land/hazardouswaste/pages/index.aspx" target="_blank">according to the MDE</a>. <br><br> This form of waste must be shipped to a specific hazardous waste facility that accepts it, but if a person has the appropriate permit, they may treat it themself. MDE inspectors routinely inspect hazardous waste generators and facilities unannounced. Household waste is not regulated as hazardous waste.',
    'composting': 'The MDE issues permits that are necessary to construct or operate a composting facility in the state, according to <a class="info-link" href="https://dsd.maryland.gov/regulations/Pages/26.04.11.05.aspx" target="_blank">Maryland law</a>. Exemptions are applicable in instances such as residential composting, composting sites that are less than 5,000 square feet or facilities that are managed by the government and compost animal carcasses as part of maintenance activities.<br><br>Composting facilities should not create disruptive odors or air pollution, harm the environment, lead to insect, rodent or animal infestations, leak pollutants to state waters or generally create hazards to public health and safety, according to the MDE.',
    'scrap-tire': 'Illegal stockpiles of scrap tires, which are tires that are no longer suitable for their original purpose, can lead to fire hazards, become breeding grounds for mosquitoes or disease-carrying agents and are “unsightly,” according to <a class="info-link" href="https://mde.maryland.gov/programs/land/recyclingandoperationsprogram/pages/scraptiredisposal.aspx" target="_blank">MDE’s website</a>. <br><br>According to the Maryland Code of the Environment, people may only dispose of scrap tires through approved facilities or licensed scrap tire haulers.',
    'sewage': 'Sewage sludge — also known as biosolids — is the semi-solid residue that is produced when sewage or wastewater is treated and decontaminated. <br><br> According to Maryland law, people are <a class="info-link" href="https://mde.maryland.gov/programs/land/rmp/pages/sewagesludge.aspx" target="_blank">not allowed</a> to transport, compost, dispose or use sewage sludge unless they have a Sewage Sludge Utilization Permit from MDE.',
    'refuse-disposal': 'According to Maryland law, anyone who installs, alters or uses a refuse disposal system is <a class="info-link" href="https://mde.maryland.gov/programs/land/solidwaste/pages/index.aspx#:~:text=Solid%20Waste%20Acceptance%20Facilities" target="_blank">required</a> to have a permit. These facilities include municipal, rubble, industrial waste, and land clearing debris landfills as well as incinerators, processing facilities and transfer stations.',
    'surface-water': 'Industrial facilities that release wastewater or stormwater into Maryland surface waters such as  lakes, creeks, streams, rivers, reservoirs and the ocean, are <a class="info-link" href="https://mde.maryland.gov/programs/permits/watermanagementpermits/pages/index.aspx" target="_blank">required to have permits</a> to do so. The permit makes sure that the discharge meets Maryland water quality standards.'
}
